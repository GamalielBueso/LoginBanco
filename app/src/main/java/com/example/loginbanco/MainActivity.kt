    ...
    fun registrar(Viste: View){
        ...
        if(nombre.length!=0 && contraseña.length!=0){
            ...
            if(nombre=="Valeria" && contraseña=="1234"){
                Toast.makeText(this, "Bienvenido al sistema bancario $nombre", Toast.LENGTH_SHORT).show()
                val vBanco:Intent = Intent(this,Banco::class.java)
                startActivity(vBanco)
            }else{
                Toast.makeText(this, "Tu usuario o contraseña son erroneas", Toast.LENGTH_SHORT).show()
            }
        }
    }
